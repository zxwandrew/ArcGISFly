...
import DeviceOrientationControls from "DeviceOrientationControls/main"
...
//
// let orientationChangeHandle = on(window, "orientationchange", controls.onScreenOrientationChangeEvent.call(controls));
// let onDeviceOrientationChangeHandle = on(window, "deviceorientation", controls.onDeviceOrientationChangeEvent.call(controls, window.DeviceOrientationEvent));
//
//
// // end test
...
socket.on('alldeviceconnected', function(data){
  if(data == "true"){//if phone connection is successful, remove top bar
    ...
    //
    // var orientationChangeHandle = on(window, "orientationchange", controls.onScreenOrientationChangeEvent.call(controls);
    // var onDeviceOrientationChangeHandle = on(window, "deviceorientation", controls.onDeviceOrientationChangeEvent.call(controls, window.DeviceOrientationEvent);
    // let something = on(window, "deviceorientation", function(evt){
